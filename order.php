...
<?php
	...
	$get_remark = "select remark from remark where reference = '$order_reference'";
    $run_remark = mysqli_query ($con,$get_remark);
	$row_remark = mysqli_fetch_array($run_remark);
	$remark = $row_remark ['remark'];
	}  
?>
...
<table width="1000" align="center" border="1" bgcolor="AquaMarine">
<tr align="center">
